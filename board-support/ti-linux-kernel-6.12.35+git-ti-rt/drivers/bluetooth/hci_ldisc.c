...
#define VERSION "2.2.09aeb7c.20230313-112554"
...
#if HCI_VERSION_CODE >= KERNEL_VERSION(3, 4, 0) && HCI_VERSION_CODE < KERNEL_VERSION(6, 8, 0)
...
*/
#if HCI_VERSION_CODE >= KERNEL_VERSION(5, 10, 0)
static int hci_uart_tty_ioctl(struct tty_struct *tty, unsigned int cmd, unsigned long arg)
#else
