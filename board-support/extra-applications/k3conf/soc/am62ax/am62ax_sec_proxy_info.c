...
struct ti_sci_sec_proxy_info am62ax_main_sp_info[] = {
	{69, "read", 38, "DM", "nonsec_low_priority_rx"},
	...
	{64, "write", 6, "DM", "nonsec_MCU_0_R5_0_response_tx"},
	{63, "write", 6, "DM", "nonsec_A53_4_response_tx"},
	{62, "write", 7, "DM", "nonsec_C7X_0_0_response_tx"},
	...
	{16, "read", 6, "MCU_0_R5_0", "response"},
	{17, "write", 5, "MCU_0_R5_0", "low_priority"},
	{18, "read", 6, "A53_4", "response"},
	{19, "write", 5, "A53_4", "low_priority"},
...
struct ti_sci_sec_proxy_info am62ax_mcu_sp_info[] = {
